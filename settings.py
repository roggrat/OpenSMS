...
SECRET_KEY = 'b0ps4cxvxqz!hm*5mz7g+!dkl7)@h@rl&y$+rt4=lu4wq!mwyj'
...
#        "sendsms_params": {"smsc": "ttyO1-modem",
#                           "from": "+7135302211", # not set automatically by SMSC
#                           "username": "opensms",
#                           "password": "opensms"}, # or set in localsettings.py
#        "coding": 0,
#        "charset": "ascii",
...
ROUTER_URL = "http://localhost:13013/cgi-bin/sendsms?from=7135302211&username=opensms&password=opensms&text=%(text)s&to=%(recipient)s&smsc=%(backend)s&dlr_url=http%%3A%%2F%%2Flocalhost%%2Frouter%%2Fdelivered%%2F%%3Fmessage_id%%3D%(id)s"
ROUTER_ADDR = "http://localhost:13013/"
ROUTER_WORKERS = 1


# rapidsms-xforms specific settings
XFORMS_HOST = 'localhost:80'
